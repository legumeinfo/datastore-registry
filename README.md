...
Typical usage:
```
  ./register_key.pl -r ds_registry.tsv -m "Pisum sativum genomes Cameor.gnm1" -stdout
```
...
```
  ./register_key.pl -r ds_registry.tsv -k XXXX -m "Mus musclus annotations Minnie.gnm1.ann1" 
```
